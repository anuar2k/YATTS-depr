    ...
    public class MemoryRepresentation : INotifyPropertyChanged {
        ...
        public MemoryRepresentation() {
            StreamedVars = new ObservableCollection<TelemVar> {
                ...
                new FloatTelemVar("g_local_scale", "", "", GAME_INFO, 13, 8),
                ...
                new FloatTelemVar("t_speed", "", "", DRIVETRAIN, 185),
                new FloatTelemVar("t_engine_rpm", "", "", DRIVETRAIN, 189),
                new S32TelemVar("t_engine_gear", "", "", DRIVETRAIN, 193),
                new S32TelemVar("t_displayed_gear", "", "", DRIVETRAIN, 197),
                new FloatTelemVar("t_input_steering", "", "", STEERING, 201),
                new FloatTelemVar("t_input_throttle", "", "", STEERING, 205),
                new FloatTelemVar("t_input_brake", "", "", STEERING, 209),
                new FloatTelemVar("t_input_clutch", "", "", STEERING, 213),
                new FloatTelemVar("t_effective_steering", "", "", STEERING, 217),
                new FloatTelemVar("t_effective_throttle", "", "", STEERING, 221),
                new FloatTelemVar("t_effective_brake", "", "", STEERING, 225),
                new FloatTelemVar("t_effective_clutch", "", "", STEERING, 229),
                new FloatTelemVar("t_cruise_control", "", "", STEERING, 233),
                ...
                new FloatTelemVar("t_brake_air_pressure", "", "", STEERING, 247),
                new BoolTelemVar("t_brake_air_pressure_warning", "", "", STEERING, 251),
                new BoolTelemVar("t_brake_air_pressure_emergency", "", "", STEERING, 252),
                new FloatTelemVar("t_brake_temperature", "", "", STEERING, 253),
                new FloatTelemVar("t_fuel", "", "", PERIPHERALS, 257),
                new BoolTelemVar("t_fuel_warning", "", "", PERIPHERALS, 261),
                new FloatTelemVar("t_fuel_average_consumption", "", "", PERIPHERALS, 262),
                new FloatTelemVar("t_fuel_range", "", "", PERIPHERALS, 266),
                new FloatTelemVar("t_adblue", "", "", PERIPHERALS, 270),
                new BoolTelemVar("t_adblue_warning", "", "", PERIPHERALS, 274),
                new FloatTelemVar("t_adblue_average_consumption", "", "", PERIPHERALS, 275),
                new FloatTelemVar("t_oil_pressure", "", "", PERIPHERALS, 279),
                new BoolTelemVar("t_oil_pressure_warning", "", "", PERIPHERALS, 283),
                new FloatTelemVar("t_oil_temperature", "", "", PERIPHERALS, 284),
                new FloatTelemVar("t_water_temperature", "", "", PERIPHERALS, 288),
                new BoolTelemVar("t_water_temperature_warning", "", "", PERIPHERALS, 292),
                new FloatTelemVar("t_battery_voltage", "", "", PERIPHERALS, 293),
                ...
                new FloatTelemVar("t_dashboard_backlight", "", "", PERIPHERALS, 319),
                new FloatTelemVar("t_wear_engine", "", "", WEAR, 323),
                new FloatTelemVar("t_wear_transmission", "", "", WEAR, 327),
                new FloatTelemVar("t_wear_cabin", "", "", WEAR, 331),
                new FloatTelemVar("t_wear_chassis", "", "", WEAR, 335),
                new FloatTelemVar("t_wear_wheels", "", "", WEAR, 339),
                new FloatTelemVar("t_odometer", "", "", PERIPHERALS, 343),
                new FloatTelemVar("t_navigation_distance", "", "", NAVIGATION, 347),
                new FloatTelemVar("t_navigation_time", "", "", NAVIGATION, 351),
                new FloatTelemVar("t_navigation_speed_limit", "", "", NAVIGATION, 355),
                new FloatTelemVar("t_wheel_susp_deflection", "", "", WHEELS, 359, TRUCK_WHEEL_COUNT),
                new BoolTelemVar("t_wheel_on_ground", "", "", WHEELS, 391, TRUCK_WHEEL_COUNT),
                new FloatTelemVar("t_wheel_velocity", "", "", WHEELS, 399, TRUCK_WHEEL_COUNT),
                new FloatTelemVar("t_wheel_steering", "", "", WHEELS, 431, TRUCK_WHEEL_COUNT),
                new FloatTelemVar("t_wheel_rotation", "", "", WHEELS, 463, TRUCK_WHEEL_COUNT),
                new FloatTelemVar("t_wheel_lift", "", "", WHEELS, 395, TRUCK_WHEEL_COUNT),
                new FloatTelemVar("t_wheel_lift_offset", "", "", WHEELS, 527, TRUCK_WHEEL_COUNT),
                ...
                new FloatTelemVar("r_wear_chassis", "", "", TRAILER, 648),
                new FloatTelemVar("r_wheel_susp_deflection", "", "", TRAILER, 652, TRAILER_WHEEL_COUNT),
                new BoolTelemVar("r_wheel_on_ground", "", "", TRAILER, 716, TRAILER_WHEEL_COUNT),
                new FloatTelemVar("r_wheel_velocity", "", "", TRAILER, 732, TRAILER_WHEEL_COUNT),
                new FloatTelemVar("r_wheel_steering", "", "", TRAILER, 796, TRAILER_WHEEL_COUNT),
                new FloatTelemVar("r_wheel_rotation", "", "", TRAILER, 860, TRAILER_WHEEL_COUNT)
            };
            ...
            ObservableCollection<TelemVar> EventVars = new ObservableCollection<TelemVar>() {
                ...
                new FloatTelemVar("ct_fuel_capacity", "", "", TRUCK, 1119),
                new FloatTelemVar("ct_fuel_warning_factor", "", "", TRUCK, 1183),
                new FloatTelemVar("ct_adblue_capacity", "", "", TRUCK, 1187),
                new FloatTelemVar("ct_adblue_warning_factor", "", "", TRUCK, 1195),
                new FloatTelemVar("ct_air_pressure_warning", "", "", TRUCK, 1199),
                new FloatTelemVar("ct_air_pressure_emergency", "", "", TRUCK, 1203),
                new FloatTelemVar("ct_oil_pressure_warning", "", "", TRUCK, 1207),
                new FloatTelemVar("ct_water_temperature_warning", "", "", TRUCK, 1211),
                new FloatTelemVar("ct_battery_voltage_warning", "", "", TRUCK, 1215),
                new FloatTelemVar("ct_rpm_limit", "", "", TRUCK, 1219),
                new U32TelemVar("ct_forward_gear_count", "", "", TRUCK, 1223),
                new U32TelemVar("ct_reverse_gear_count", "", "", TRUCK, 1227),
                new FloatTelemVar("ct_differential_ratio", "", "", TRUCK, 1231),
                ...
                new FloatTelemVar("ct_wheel_radius", "", "", TRUCK, 1391, TRUCK_WHEEL_COUNT),
                ...
                new FloatTelemVar("ct_forward_ratio", "", "", TRUCK, 1439, FWD_GEAR_COUNT),
                new FloatTelemVar("ct_reverse_ratio", "", "", TRUCK, 1567, RVS_GEAR_COUNT),
                ...
                new FloatTelemVar("cr_wheel_radius", "", "", TRAILER, 1999, TRAILER_WHEEL_COUNT),
                ...
                new FloatTelemVar("cj_cargo_mass", "", "", JOB, 2223),
